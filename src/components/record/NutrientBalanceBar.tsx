...
const NutrientProgressRow: React.FC<{ label: string; data: NutrientData }> = ({ label, data }) => (
  <View className='mt-3'>
...
// NutrientBalanceCard가 받을 props 타입 정의
...
const NutrientBalanceBar: React.FC<NutrientBalanceCardProps> = ({ title, nutrients }) => {
  return (
